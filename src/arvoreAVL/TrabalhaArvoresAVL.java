...
public class TrabalhaArvoresAVL {
    ...
    public void gerarArquivoArvoreAVL(String nomeEntrada, String nomeSaida) throws IOException {
        ...
        while ((cpf = br.readLine()) != null) {
            NoAVL noEncontrado = arvoreAVL.pesquisar(cpf);
    ...
    private void escreverDadosNoArquivo(BufferedWriter bw, NoAVL no, String cpfProcurado) throws IOException {
        if (no != null) {
    ...
    private double percorrerArvore(BufferedWriter bw, NoAVL no, String cpfProcurado) throws IOException {
        double saldoTotal = 0;
